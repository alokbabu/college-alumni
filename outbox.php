	...
	<div class="container">
		...
		<div class="col-md-2">
			<ul class="list-group">
			  ...
			  <a class="list-group-item active" href="outbox.php">Sent</a></li>
			</ul>
		</div>
		<?php
			...
			<ul class="nav nav-tabs">
			  ...
			  <li role="presentation"><a href="status.php">Status</a></li>
				...
				<div class="row" style="border: 1px solid #c9c9c9; padding: 18px; margin:2px 2px;">
					<div>Regrie Freder</div>
					<small>Message</small>
					<span class="text-disabled" style="display:block; font-size:11px;">Sent on 19-08-20015 12:30 PM</span>
				</div>
				<div class="row" style="border: 1px solid #c9c9c9; padding: 18px; margin:2px 2px;">
					<div>Alex Nolen</div>
					<small>Message</small>
